...
(defn plane-dynamic-solution [tr-x tr-y   p-x p-y ]
...
(defn ufo-dynamic-solution [pl-x pl-y trg-x trg-y  ]       ( / ( - (  Math/acos (  / ( - ( + ( * 1000 ( - trg-y pl-y)) (* ( - trg-x pl-x) ( - trg-x pl-x)))) 
( * 1000 ( Math/sqrt ( + ( * ( - trg-y pl-y) ( - trg-y pl-y)) ( * ( - trg-x pl-x) ( - trg-x pl-x))))))  )  ( Math/asin ( / ( - trg-x pl-x)
